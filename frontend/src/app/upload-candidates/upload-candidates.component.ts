...
export class UploadCandidatesComponent {
  ...
  constructor(private http: HttpClient, private dialogRef: MatDialogRef<UploadCandidatesComponent>, private snackBar : MatSnackBar) {}
  ...
  onUpload(): void {
    if (this.selectedFile) {
      ...
      if (this.selectedFile.name.endsWith('.xlsx')) {
        ...
        this.http.post('http://localhost:8080/candidates/upload-candidate-credentials-forTest', formData, {
